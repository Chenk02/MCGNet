    ...
    for batch_idx, batch_data_label in enumerate(TEST_DATALOADER):
        ...
        # if True:
            dump_results(end_points, DUMP_DIR + '/result/', DATASET_CONFIG, TEST_DATASET,
                         opt_ang=(FLAGS.dataset == 'sunrgbd'))

        if batch_idx == 0:
            torch.save(end_points['features_map'],'/home/ck/code/H3DNet/result/weight_map/weight_map.pth')
            torch.save(end_points['pnet_features_map'],'/home/ck/code/H3DNet/result/weight_map/pnet_weight_map.pth')
