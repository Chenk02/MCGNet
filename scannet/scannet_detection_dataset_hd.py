...
class ScannetDetectionDataset(Dataset):
    ...
    def __init__(self, data_path=None, split_set='train', num_points=20000, center_dev=2.0, corner_dev=1.0,
        ...
        # self.data_path = os.path.join(ROOT_DIR, 'scannet/scans')
...
if __name__=='__main__':
    dset = ScannetDetectionDataset(data_path='scannet_train_detection_data', split_set='train', use_height=True, num_points=50000, augment=False, use_angle=False)
